...
//Fucking funci贸n para generar un entero aleatorio dentro de un rango
...
//fucking funci髇 que devuelve 1 si parametro es  + y -1 si parametro es -
function getSign(n) {
    if (n>=0) {
        return 1;
    }
 ...
 * MovingBehaviour
 *
 * Proporciona los medios b谩sicos para crear un patron de movimiento
 * dx y dy son los delta, es decir en cuanto se modifica la posici贸n del objeto
 * al moverlo.
 *
 * @param Sprite sprite
 * @param Canvas canvas
...
/**
 * El m茅todo  move simplemente agrega los delta a la posici贸n del objeto
 */
...
/**
 * Este m茅todo verifica si el objeto padre del comportamiento rebotar est谩
...
/**
 * Este objeto es el padre de todo lo que se ver谩 en la pantalla.
 *
 * @param {*} color
 * @param {*} context
 */
...
var Game = (function() {
    ...
    var _settings = {
            ...
            maxJump       : 112,
            /**
             * Basado en la notaci贸n Fehn del ajedrez.
             ...
             * donde los n煤meros representan un espacio vacio, y las x representan un espacio
             * a pintar, para ser ocupado por una plataforma.
             * tener en cuenta que, para efectos de dise帽ar escenas, la grilla es de 32x32.
             */
    ...
    /**
     * La factory posee la funcionalidad de "saber" din醡icamente
